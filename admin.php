...
<h3 class="card-title"><i class="fa-solid fa-user-shield"></i> Administrator list</h3> <button type="button" data-toggle="modal" data-target="#add" class="btn float-right  btn-success btn-md"> <i class="fa-solid fa-user-shield"></i> Add Administrator</button>
</div>
...
<td>'.$row['email'].'</td>
<td> '.$row['contact'].'</td>
<td><span class="badge bg-success"> <i class="fa-solid fa-user-shield"></i> Administrator</span></td>
...
<div class="modal fade" id="del'.$row['id'].'" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <center> <h2 class="text-bold"> Delete Admin Account ???  </h2> </center>
         <form style="display:none;" method="post" action="admin.php">
...
<span id='message'></span> 
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" id="admin_add" name="add_admin" class="btn btn-primary">Add Admin</button>
      </form>
      </div>
    </div>
  </div>
...
VALUES ('$fullname', '$email', '$contact', '$password', 'Admin')";
...
$uid = $_SESSION['id'];
$fullname1 = $_SESSION['fullname'];
$activity = ' Added New '.$fullname.' Admin Account ';
$sql = "INSERT INTO logs (user_id, fullname, activity, month, day, year, time)
VALUES ('$uid', '$fullname1', '$activity', '$month', '$day', '$year', '$time')";
