...
<head>
  ...
  <title> Product Sales Report | Sembrano Store</title>
...
<h3 class="card-title">  
     ...
     <div class="row">
               ...
               <div class="col-4">
                           ...
                           <a href="sales_report_filter_print.php?month=<?php echo $_GET['month']; ?>&year=<?php echo $_GET['year']; ?>" target="_blank"> <button type="button"   class="btn btn-success  float-left"><i class="fa-solid fa-print"></i> Print Sales Report</button>  </a>
...
<div class="card-body">
<h2><?php echo $_GET['month']; ?> <?php echo $_GET['year']; ?> Sales Report</h2>
...
<?php
 ...
 $years = $_GET['year'];
$grand_gross = 0;
$sql = "SELECT * FROM payment where month='$months'   and year='$years'  group by  month, year order by id DESC";
...
//////////////////22222222222222
    $sql2 = "SELECT  * from orders where month ='$month'   and year='$year' group by order_number, month,  year ";
...
$sql3 = "SELECT SUM(amount) as total FROM payment where  status !='Pending'  ";
...
$sql4 = "SELECT * FROM orders where payment_status = 'Confirmed'     ";
