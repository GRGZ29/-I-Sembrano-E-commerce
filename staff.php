...
<head>
  ...
  <title>Manage Staff | Sembrano Store</title>
...
<h3 class="card-title"><i class="fa-solid fa-user-shield"></i> Staf list</h3> <button type="button" data-toggle="modal" data-target="#add" class="btn float-right  btn-success btn-md"> <i class="fa-solid fa-address-card"></i> Add Staff</button>
</div>
...
$sql = "SELECT * FROM admin where role = 'Staff' ";
...
<td>'.$row['email'].'</td>
<td> '.$row['contact'].'</td>
<td><span class="badge bg-info">   <i class="fa-solid fa-address-card"></i> Store Staff</span></td>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"> Staff ID # : '.$row['id'].'</h5>
...
<li class="nav-item">
<a class="nav-link active" id="custom-content-below-messages-tab'.$row['id'].'" data-toggle="pill" href="#custom-content-below-messages'.$row['id'].'" role="tab" aria-controls="custom-content-below-messages'.$row['id'].'" aria-selected="false">Store Staff Information</a>
</li>
...
<div class="modal fade" id="del'.$row['id'].'" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
    <center> <h2 class="text-bold"> Delete Staff Account ???  </h2> </center>
         <form style="display:none;" method="post" action="staff.php">
...
function myMessage() {
  ...
  position: "center",
  icon: "success",
  title: "Successfully Deleted Staff info",
...
$sql = "UPDATE admin SET fullname ='$fullname', email= '$email', contact = '$contact'  WHERE id='$user_id'";
...
function myMessage() {
  ...
  position: "center",
  icon: "success",
  title: "Successfully Updated Staff info",
  showConfirmButton: false,
  timer: 3000
})
}
...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog  modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Store Staff</h5>
...
<span id='message'></span> 
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" id="staff1" name="add_staff" class="btn btn-primary">Add Staff</button>
      </form>
      </div>
    </div>
  </div>
...
$sql = "INSERT INTO admin (fullname,email,contact,password, role)
VALUES ('$fullname', '$email', '$contact', '$password', 'Staff')";
